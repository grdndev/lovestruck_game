...
define mycharacter1 = Character("books.names[\"storyidfn1\"]",color="#FFFFFF", who_underline=True,what_prefix='"', what_suffix='"', what_outlines=[ (tsize, "#000") ],who_outlines=[(tsize, "#000")], ctc = "ctc_", dynamic = True)
define mycharacter2 = Character("books.names[\"storyidfn2\"]",color="#FFFFFF", who_underline=True,what_prefix='"', what_suffix='"', what_outlines=[ (tsize, "#000") ],who_outlines=[(tsize, "#000")], ctc = "ctc_", dynamic = True)

init python:
    #This line will need to be updated every time you add a new season or episode.
    addstory(story_id = "storyid", story_name = "Custom Story", story_book = "hifl", story_seasonlength = 12, seasons = 1, episodes = 2, nameablecharacters = 2)
    ...
    desc.storyid_season1_episode1_description = "This episode teaches you how to do most of the things you'll need to make an episode."
    desc.storyid_season1_episode2_description = "This episode is an empty template you can use to write an episode."
