...
#$namefn = books.names["mscstoryidfn2"]
#$nameln = books.names["mscstoryidln2"]
...
label mscstoryid_season1_episode1:
    $tbc = False
    ...
    #Each character with an accessory slot will have a blank accessory. Show that instead to hide the accessory.
    show wade casual sad glassesoff
    pause
